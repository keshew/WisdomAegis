...
struct WisdomBooksView: View {
    @StateObject var viewModel =  WisdomBooksViewModel()
    @State var isPaytable = false
    @Environment(\.presentationMode) var presentationMode
    let symbolArray = [Symbol(image: "wisdom2", value: "500"),
            ...
            ScrollView(showsIndicators: false) {
                VStack {
                    VStack(spacing: 15) {
                        ...
                        Text("Wisdom's Books")
                            .FontSemiBold(size: 20, color: Color(red: 234/255, green: 1/255, blue: 255/255))
                    }
                        ...
                        Rectangle()
                            ...
                            .overlay  {
                                RoundedRectangle(cornerRadius: 50)
                                    .stroke(Color(red: 234/255, green: 1/255, blue: 255/255), lineWidth: 5)
                                    .overlay {
                                        Text("SPIN")
                                            .FontRegular(size: 24, color: Color(red: 234/255, green: 1/255, blue: 255/255))
                                    }
                            }
                            .cornerRadius(50)
                            .padding(.horizontal, 40)
                ...
                Rectangle()
                    ...
                    .overlay {
                        RoundedRectangle(cornerRadius: 32)
                            .stroke(Color(red: 234/255, green: 1/255, blue: 255/255), lineWidth: 3)
                            .overlay {
                                VStack(alignment: .leading, spacing: 22) {
                                    HStack {
                                        Text("Paytable")
                                            .FontRegular(size: 16, color: Color(red: 234/255, green: 1/255, blue: 255/255))
                                                    ...
                                                    VStack {
                                                        HStack {
                                                            Text("SPECIAL SYMBOLS")
                                                                .FontBold(size: 12, color: Color(red: 234/255, green: 1/255, blue: 255/255))
