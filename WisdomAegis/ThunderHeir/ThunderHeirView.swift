...
struct ThunderHeirView: View {
    @StateObject var viewModel =  ThunderHeirViewModel()
    @State var isPaytable = false
    @Environment(\.presentationMode) var presentationMode
    let symbolArray = [Symbol(image: "heir2", value: "500"),
            ...
            ScrollView(showsIndicators: false) {
                VStack {
                    VStack(spacing: 15) {
                        ...
                        Text("Thunder Heir")
                            .FontSemiBold(size: 20, color: Color(red: 199/255, green: 168/255, blue: 106/255))
                    }
                                            ...
                                            HStack(spacing: 0) {
                                                ForEach(0..<3, id: \.self) { col in
                                                    Rectangle()
                                                        ...
                                                        .shadow(
                                                            color: viewModel.winningPositions.contains(where: { $0.row == row && $0.col == col }) ? .yellow : .clear,
                        ...
                        Rectangle()
                            ...
                            .overlay  {
                                RoundedRectangle(cornerRadius: 50)
                                    .stroke(Color(red: 199/255, green: 168/255, blue: 106/255), lineWidth: 4)
                                    .overlay {
                                        Text("SPIN")
                                            .FontRegular(size: 24, color: Color(red: 255/255, green: 169/255, blue: 0/255))
                                    }
                            }
                            .cornerRadius(50)
                            .padding(.horizontal, 40)
